...
-- ============================================================
-- 1. CREATE ALL TABLES (ordered by foreign key dependencies)
-- ============================================================
...
-- Group Members (depends on: users, groups)
...
-- Meetups (depends on: groups, users)
...
-- Meetup RSVPs (depends on: meetups, users)
...
-- DM Threads (depends on: users, groups)
...
-- Messages (depends on: groups, dm_threads, users)
...
-- Recco Posts (depends on: contributors)
...
-- Saved Posts (depends on: users, recco_posts)
...
-- Matching Queue (depends on: users)
...
-- ============================================================
-- 3. RLS POLICIES (all tables exist, safe to cross-reference)
-- ============================================================
